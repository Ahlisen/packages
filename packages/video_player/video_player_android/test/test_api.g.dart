  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.load was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final LoadMessage? arg_msg = (args[0] as LoadMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.load was null, expected non-null LoadMessage.');
          api.load(arg_msg!);
          return <Object?>[];
        });
      }
